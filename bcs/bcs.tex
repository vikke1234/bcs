...
\title{FPGA Implementations Of Lattice Based Cryptography}
\author{Viktor Horsmanheimo}
\date{\today}

\supervisors{Prof. Valtteri Niemi, Dr. Mohamed Taoufiq Damir}

\keywords{FPGA, cryptography, R-LWE, post-quantum}
...
\  CCS $\rightarrow$ Security and privacy $\rightarrow$ Cryptography
$\rightarrow$ Public key (assymetric) techniques $\rightarrow$ Public key
encryption
}}
...
\hypersetup{
    ...
    pdftitle={FPGA implementation of R-LWE},            % title
...
\include{Ch.20_FPGA}
\include{Ch.30_Cryptography}
\include{Ch.40_FPGA_Cryptography}
\include{Ch.50_Conclusion}
